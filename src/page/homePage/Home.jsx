...
import Dan from '../../assets/images/iPhone-13-PRO-MAX-localhost (1).png';
    ...
    <div> 
        ...
        <Animatedd>
          <div className="text-white text-center">
            <p className='text-[1rem] '>Find Your Bliss at RoyalHomes</p>
            <h1 className='text-[2rem] font-bold '>Embark on Your Journey to Exceptional Comfort and Luxury with RoyalHomes</h1>
          </div>
       </Animatedd>
        <div className='grid ml-[20px] justify-center sm:ml-[90px] xl:flex col gap-10 justify-center mt-[40px] md:grid lg:grid'>
          ...
          <div className='md:ml-[15px]'>
            ...
            <p className='sm:w-[70vw] text-[black] md:w-[80vw] md:text-[1.5rem] xl:w-[25vw] xl:text-[1.2rem] '>RoyalHomes tailors stays to individual preferences, ensuring a unique and personalized travel experience for each user.</p>
          </div>
            ...
            <div className='md:ml-[15px]'>
              ...
              <p className='sm:w-[70vw] text-[black] xl:w-[25vw] xl:text-[1.2rem] md:w-[80vw] md:text-[1.4rem]'>RoyalHomes prioritizes user convenience with an intuitive and hassle-free booking process, making it easy for travelers to secure their ideal accommodations..</p>
            </div>
          ...
          <div className='md:ml-[15px]'>
            ...
            <p className='sm:w-[70vw] text-[black] xl:w-[25vw] xl:text-[1.2rem] md:w-[80vw] md:text-[1.4rem]'>RoyalHomes provides extensive amenities and intuitive tools for seamless booking, ensuring guests find their perfect stay with ease and confidence.</p>
          </div>
        ...
        <div className='text-center mt-[10rem]' >
          <h3 className='text-[#52624E] uppercase font-bold text-[1.5rem] font-serif'>Welcome to RoyalHomes</h3>
          <h1 className=' text-[1.5rem] text-[black] mt-[10px] w-full lg:w-full lg:text-[3rem] md:text-[2rem]'>RoyalHomes offers extraordinary accommodations, personalized 
         <br /> services, and the promise of unforgettable 
        <br /> holiday experiences.</h1>
            <p className='text-[#8E908E] mt-[30px] mb-[30px] text-[13px] w-full lg:w-full xl:text-[20px] md:text-[18px]'>RoyalHomes offers exceptional lodgings, a blend of harmonious hotels and chalets. Each room 
           <br /> boasts unique decor, Victorian furniture, and luxurious amenities. Our authentic hospitality invites you to stay,
           <br /> indulge, and relish the best in comfortable accommodations at RoyalHomes.</p>
        </div>
      ...
      <div className='grid justify-center gap-9  p-[5rem] xl:flex col sm:grid md:flex col' >
        ...
        <div className='mt-[10px] xl:mt-[120px] md:mt-[70px]'>
          <p className='w-[75vw] text-[#B99D75] text-[20px] font-serif xl:w-[35vw] md:w-[30vw]'>Indulge in luxury at RoyalHomes's prime serviced apartments for exceptional comfort.</p>
          ...
          <div className='grid justify-center sm:flex sm:gap-[0] sm:justify-center'> 
              ...
              <div className='mt-[40px] ml-[4%] sm:mt-[40px] md:mt-[80px]'>
                ...
                sm:text-[1rem] sm:w-[40vw] sm:mt-[0] xl:w-[40vw] xl:text-[2rem] xl:mt-[10rem]
                 ...
                 [@media(min-width:1100px)]:mt-[2rem] '>Be the first to explore RoyalHomes's revolutionary booking app. Secure your spot on the 
                ...
                <p className='text-black text-[17px] mt-[20px] '>Unlock exclusive benefits, early access, and unbeatable deals! Join our waitlist today to secure your spot and be the first to experience luxury with RoyalHomes. Don't miss out!</p>
      ...
      <div className='mt-[40px]'>
          ...
          <div className="relative h-[55vh] group flex items-center justify-center bg-cover bg-center" 
                ...
                <div className="text-white text-center z-10">
                  <h1 className='text-[1.5rem] font-serif  font-bold sm:text-[2rem] font-serif'>Discover Comfort at RoyalHomes</h1>
